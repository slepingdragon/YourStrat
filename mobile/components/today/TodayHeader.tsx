...
export function timeOfDayTag(hour: number): string {
  if (hour < 11) return translate("today.morning");
  if (hour < 14) return translate("today.midday");
  if (hour < 18) return translate("today.afternoon");
  if (hour < 22) return translate("today.evening");
  return translate("today.lateNight");
}
